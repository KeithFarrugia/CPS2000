...
class Gen_Visitor : public AST_Visitor{
public:
    Gen_Visitor();
...
private:
    ...
    variable_index_t        getVariableIndex            (std::string variable_name);
    ...
    int                     sumFunctionParam            (std::string function_name);

    // ---------------------------------------------------------------------------------------- Instuction related functions
    int                     popInstructionNum           ();
    int                     getCurrentInstructionNumber ();
    int                     addBlankInstructions        ();
    void                    pushInstructionNum          (int num);
    void                    addNewInstruction           (std::string instruction);
    void                    PatchNewInstruction         (int num, std::string instruction);
    ...
    std::vector<scope_t>        func_scope;
    std::vector<std::string>    compiled_code;
    std::vector<function_t>     global_functions;
    std::vector<int>            instruction_stack;
